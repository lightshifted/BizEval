class BizEval:
    ...
    def return_on_investment(self, net_profit, initial_investment):
    ...
    def calc_npv(self, investment, discount_rate, cash_flows):
        """
    ...
    def payback_period(self, initial_investment, annual_cash_flow):
    ...
    def break_even_point(self, fixed_costs, price, variable_costs):
    ...
    def operating_profit_margin(self, revenue, operating_expenses):
    ...
    def ebitda(self, revenue, costs, interest, taxes, depreciation, amortization):
    ...
    def operating_pe_ratio(self, market_value, operating_income):
